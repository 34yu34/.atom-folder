  ...
  module.exports = {
    ...
    generate: function() {
      ...
      work = {
        ...
        headerPath: this.editor.getPath(),
        headerName: this.editor.getTitle(),
        implementationName: this.headerName.replace(".h", ".cpp"),
        implementationPath: this.headerPath.replace(".h", ".cpp"),
        classname: ""
      };
      work.editor.save();
      CreateFile(work);
